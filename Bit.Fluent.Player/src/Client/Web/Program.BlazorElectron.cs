using Bit.Fluent.Player.Client.Core.Shared;
#if BlazorElectron
using ElectronNET.API;
using ElectronNET.API.Entities;
#endif

namespace Bit.Fluent.Player.Client.Web;
...
public partial class Program
{
    ...
    public static WebApplication CreateHostBuilder(string[] args)
    {
        ...
        builder.Configuration.AddJsonStream(typeof(MainLayout).Assembly.GetManifestResourceStream("Bit.Fluent.Player.Client.Core.appsettings.json")!);
