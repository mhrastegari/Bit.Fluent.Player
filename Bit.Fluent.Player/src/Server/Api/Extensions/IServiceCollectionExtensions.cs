...
using Bit.Fluent.Player.Server.Api;
using Bit.Fluent.Player.Server.Api.Models.Identity;
using Bit.Fluent.Player.Server.Api.Services.Implementations;
...
public static class IServiceCollectionExtensions
{
    ...
    public static void AddSwaggerGen(this IServiceCollection services)
    {
        ...
        {
            options.IncludeXmlComments(Path.Combine(AppContext.BaseDirectory, "Bit.Fluent.Player.Server.Api.xml"));
            options.IncludeXmlComments(Path.Combine(AppContext.BaseDirectory, "Bit.Fluent.Player.Shared.xml"));
    ...
    public static void AddHealthChecks(this IServiceCollection services, IWebHostEnvironment env, IConfiguration configuration)
    {
        ...
        {
            setup.AddHealthCheckEndpoint("TodoHealthChecks", env.IsDevelopment() ? "https://localhost:5041/healthz" : "/healthz");
        }).AddInMemoryStorage();
