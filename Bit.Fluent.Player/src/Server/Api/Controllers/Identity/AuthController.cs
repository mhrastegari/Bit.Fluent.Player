...
using Bit.Fluent.Player.Server.Api.Models.Emailing;

namespace Bit.Fluent.Player.Server.Api.Controllers.Identity;
...
public partial class AuthController : AppControllerBase
{
    ...
    private async Task SendConfirmationEmail(SendConfirmationEmailRequestDto sendConfirmationEmailRequest, User user, CancellationToken cancellationToken)
    {
        ...
        var result = await _fluentEmail
            ...
            .UsingTemplateFromEmbedded("Bit.Fluent.Player.Server.Api.Resources.EmailConfirmation.cshtml",
        ...
        , CancellationToken cancellationToken)
    {
        ...
        var result = await _fluentEmail
            ...
            .UsingTemplateFromEmbedded("Bit.Fluent.Player.Server.Api.Resources.ResetPassword.cshtml",
